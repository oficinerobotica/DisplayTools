...
from HelperTools.grid_creator import createGrid  # Add this import
...
class ViewProviderDynamicGrid():
    ...
    def attach(self, vobj):
        ...
        self.actualGrid = createGrid(self.Object, self.grid_material)
        ...
        # Initialize grid position based on scene content
    ...
    def updateData(self, fp, prop):
        ...
        if prop == 'Placement':
            ...
            newGrid = createGrid(self.Object, self.grid_material)  # Modified to use imported function
